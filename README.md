This is a hardware implementation of the UART protocol using the HDL language Verilog. The words transferred from the UART channel will be displayed in four 7-segment LED displays.
